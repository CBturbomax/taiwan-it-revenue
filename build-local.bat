@echo off
REM ===========================================================================
REM  WARNING -- DO NOT USE THIS FOR ROUTINE UPDATES.
REM
REM  Building locally does heavy file I/O (SQLite writes, ~2.6MB HTML, git
REM  objects) and this PC blue-screens under that load: bugcheck 0x50 in a
REM  stacked filesystem-filter driver, five times since 2026-06.
REM  The security software cannot be removed, so avoid the trigger instead.
REM
REM  Use run.bat -- it just asks the GitHub server to rebuild, touching
REM  nothing on this machine. Come here only when the server itself is broken
REM  and you need to see the build output locally.
REM ===========================================================================
REM
REM build-local.bat -- full local build: master, revenue, names, dashboard, publish.
REM (previously run.bat)
REM
